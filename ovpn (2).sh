...
updating_the_dirs(){
 ...
 ${Blue}3.${Font_color_suffix} ${Yellow}NPB 5, продолжение следует...(Франшиза)${Font_color_suffix}"
...
${Blue}|16.${Font_color_suffix} ${Yellow}Доп.функции${Font_color_suffix}                     ${Blue}|${Font_color_suffix}
${Blue}|17.${Font_color_suffix} ${Yellow}Выйти${Font_color_suffix}                           ${Blue}|${Font_color_suffix}
${Blue}|------------------------------------|${Font_color_suffix}"
